...
class QuotationApp:
    ...
    def create_widgets(self):
        ...
        # 毛利率输入框
        tk.Label(bottom_frame, text="毛利率（%）：").pack(side=tk.LEFT, padx=(20, 0))
        self.profit_margin_entry = ttk.Entry(bottom_frame, width=10)
        ...
        # 最终含税总价显示
        tk.Label(bottom_frame, text="最终含税总价：").pack(side=tk.LEFT, padx=(20, 0))
        self.final_total_label = ttk.Entry(bottom_frame, font=("Arial", 14, "bold"), state="readonly", width=15)
        self.final_total_label.pack(side=tk.LEFT, padx=5)
        
        tk.Label(bottom_frame, text="大写金额：").pack(side=tk.LEFT, padx=(20, 0))
        self.final_total_cn_label = ttk.Entry(bottom_frame, font=("Arial", 14), state="readonly")
        self.final_total_cn_label.pack(side=tk.LEFT, padx=5, fill=tk.X, expand=True)
